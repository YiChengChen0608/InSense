  ...
  return (
    <div className="class-wrapper">
      <div className="change-btn d-flex">
        <a
          className={`${myClassSelected ? "btn-selected" : ""}`}
          onClick={(event) => changeSelectHandler(event)}
          role="button"
          data-select="myClass"
        >
          已報名
        ...
        <a
          className={`${allClassSelected ? "btn-selected" : ""}`}
          onClick={(event) => changeSelectHandler(event)}
          role="button"
          data-select="allClass"
        >
          課程紀錄
        </a>
      </div>
